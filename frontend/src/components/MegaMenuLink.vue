...
const iconSvg = computed(() => {
  ...
  // If it's just a path, wrap it in SVG
  return `<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="${props.icon}"/></svg>`
})
</script>
